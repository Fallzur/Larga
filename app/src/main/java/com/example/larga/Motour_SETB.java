...
import com.example.larga.databinding.ActivityMotourSetbBinding;
...
public class Motour_SETB extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityMotourSetbBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMotourSetbBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());


        spotb = findViewById(R.id.spotb);

        lat = findViewById(R.id.trlatB);
        lon = findViewById(R.id.trlonB);
        add = findViewById(R.id.traddB);
        lat.setVisibility(View.INVISIBLE);
        lon.setVisibility(View.INVISIBLE);
        add.setVisibility(View.INVISIBLE);


        ImageView gifImageView = findViewById(R.id.trloading_setB);
        cancel = findViewById(R.id.tr_cancel_setB);
...
// Load and display the GIF using Glide
        ...
        relative1 = findViewById(R.id.LocationNav_setB);
        relative2 = findViewById(R.id.findingNav_setB);
        ...
        Start = findViewById(R.id.Start_setB);

        location1 = findViewById(R.id.loc_1_setB);
        location2 = findViewById(R.id.loc_2_setB);
        location3 = findViewById(R.id.loc_3_setB);


        view1 = findViewById(R.id.view_loc_1_setB);
        view2 = findViewById(R.id.view_loc_2_setB);
        view3 = findViewById(R.id.view_loc_3_setB);


        img1 = findViewById(R.id.img1_setB);
        img2 = findViewById(R.id.img2_setB);
        img3 = findViewById(R.id.img3_setB);

ContactingYourDriver = findViewById(R.id.ContactingDriver);
        ...
        view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                spotb.setText("Banza church ruins");
        ...
        view2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                spotb.setText("Boat buildinig site");
        ...
        view3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                spotb.setText("Nipa wine destilliry");
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map_setb);
    ...
    public void updateLocation1() {
        updateMap(8.97218404230462, 125.53843399614497, "Banza Butuan City,  Banza church ruins");
    }

    public void updateLocation2() {
        updateMap(8.954101135458473, 125.4963162568885, "Banza Butuan City,  Balangay boat building site");
    }

    public void updateLocation3() {
        updateMap(8.958681885916157, 125.52891368554381, "Libertad butuan city ,Nipa wine destilliry");
    }
    ...
    private void updateGPS() {
        ...
        //Updet the ui--------------------------------------------------------------------------
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(Motour_SETB.this);
...
// values of location into ui components
                    ...
                    Toast.makeText(Motour_SETB.this, "location access", Toast.LENGTH_SHORT).show();
    ...
    private void updateUIValues(Location location) {
        ...
        Geocoder geocoder = new Geocoder(Motour_SETB.this);
        try {
    ...
    public void StartSet_A_sendData(){
        ...
        databaseReference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(Motour_SETB.this, "Request sent  Successfully", Toast.LENGTH_SHORT).show();
        ...
        mDatabaseReference.setValue(newStatusValue).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(Motour_SETB.this, "Request Aborded", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                    relative1.setVisibility(View.VISIBLE);
                    relative2.setVisibility(View.INVISIBLE);
                } else {
